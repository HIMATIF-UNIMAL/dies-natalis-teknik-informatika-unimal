                          ...
                          <tbody>
                            <?php foreach($hasil as $data){ ?>
                              <tr>
                                  ...
                                  <td>
                                  <a href="<?= base_url('cipta_puisi/aksi_terima/'.$data->id) ?>" class="btn btn-icon btn-success">
                                    <span class="tf-icons bx bx-check"></span>
                                  </a>
                                  <a href="<?= base_url('cipta_puisi/aksi_tolak/'.$data->id) ?>" class="btn btn-icon btn-danger">
