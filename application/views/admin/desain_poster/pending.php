                          ...
                          <tbody>
                            <?php foreach($hasil as $data){ ?>
                              <tr>
                                  ...
                                  <td>
                                  <a href="<?= base_url('desain_poster/aksi_terima/'.$data->id) ?>" class="btn btn-icon btn-success">
                                    <span class="tf-icons bx bx-check"></span>
                                  </a>
                                  <a href="<?= base_url('desain_poster/aksi_tolak/'.$data->id) ?>" class="btn btn-icon btn-danger">
