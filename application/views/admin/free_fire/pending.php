                          ...
                          <tbody>
                            <?php foreach($hasil as $data){ ?>
                              <tr>
                                  ...
                                  <a href="<?= base_url('free_fire/aksi_terima/'.$data->id) ?>" class="btn btn-icon btn-success">
                                    <span class="tf-icons bx bx-check"></span>
                                  </a>
                                  <a href="<?= base_url('free_fire/aksi_tolak/'.$data->id) ?>" class="btn btn-icon btn-danger">
