                    ...
                    <div class="row g-0 align-items-center">
                      ...
                      <div class="col-lg-7">
                        <div class="card-body">
                          ...
                          <p class="card-text">Bootcamp "frontend developer" bekerjasama dengan permikomnas wilayah I</p>
                          <span class="card-text"><a href="">Daftar Sekarang</a></span>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-md">
                  <div class="card mb-3">
                    ...
                    <div class="col-lg-5">
                      ...
                      <div class="col-lg-7">
                        <div class="card-body">
                          <h5 class="card-title">Diskusi Publik</h5>
                          <p class="card-text">
                            Diskusi publik dengan tema "lorem ipsum dolar sit amet"
                          </p>
                          <span class="card-text"><a href="">Daftar Sekarang</a></span>
                        </div>
                      </div>
